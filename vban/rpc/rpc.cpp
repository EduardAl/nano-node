...
vban::rpc::rpc (boost::asio::io_context & io_ctx_a, vban::rpc_config const & config_a, vban::rpc_handler_interface & rpc_handler_interface_a) :
	config (config_a),
	acceptor (io_ctx_a),
...
void vban::rpc::accept ()
{
	auto connection (std::make_shared<vban::rpc_connection> (config, io_ctx, logger, rpc_handler_interface));
...
std::unique_ptr<vban::rpc> vban::get_rpc (boost::asio::io_context & io_ctx_a, vban::rpc_config const & config_a, vban::rpc_handler_interface & rpc_handler_interface_a)
{
