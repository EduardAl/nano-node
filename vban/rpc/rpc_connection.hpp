...
class rpc_connection : public std::enable_shared_from_this<vban::rpc_connection>
{
public:
	rpc_connection (vban::rpc_config const & rpc_config, boost::asio::io_context & io_ctx, vban::logger_mt & logger, vban::rpc_handler_interface & rpc_handler_interface_a);
	virtual ~rpc_connection () = default;
	virtual void parse_connection ();
	virtual void write_completion_handler (std::shared_ptr<vban::rpc_connection> const & rpc_connection);
