...
public:
	timer () = default;
	timer (vban::timer_state state_a, std::string const & description_a = "timer");
	...
	vban::timer_state current_state () const;

private:
	timer * parent{ nullptr };
	std::vector<timer> children;
	vban::timer_state state{ vban::timer_state::stopped };
	std::string desc;
