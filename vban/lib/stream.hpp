...
template <typename T>
bool try_read (vban::stream & stream_a, T & value_a)
{
...
template <typename T>
void read (vban::stream & stream_a, T & value)
{
...
inline void read (vban::stream & stream_a, std::vector<uint8_t> & value_a, size_t size_a)
{
...
template <typename T>
void write (vban::stream & stream_a, T const & value_a)
{
...
inline void write (vban::stream & stream_a, std::vector<uint8_t> const & value_a)
{
