...
#ifndef FLATBUFFERS_GENERATED_VBANAPI_VBANAPI_H_
#define FLATBUFFERS_GENERATED_VBANAPI_VBANAPI_H_
...
template<> struct BlockTraits<vbanapi::BlockState> {
  static const Block enum_value = Block_BlockState;
};

template<> struct BlockTraits<vbanapi::BlockOpen> {
  static const Block enum_value = Block_BlockOpen;
};

template<> struct BlockTraits<vbanapi::BlockReceive> {
  static const Block enum_value = Block_BlockReceive;
};

template<> struct BlockTraits<vbanapi::BlockSend> {
  static const Block enum_value = Block_BlockSend;
};

template<> struct BlockTraits<vbanapi::BlockChange> {
...
struct BlockUnion {
  ...
  vbanapi::BlockStateT *AsBlockState() {
    return type == Block_BlockState ?
      reinterpret_cast<vbanapi::BlockStateT *>(value) : nullptr;
  }
  const vbanapi::BlockStateT *AsBlockState() const {
    return type == Block_BlockState ?
      reinterpret_cast<const vbanapi::BlockStateT *>(value) : nullptr;
  }
  vbanapi::BlockOpenT *AsBlockOpen() {
    return type == Block_BlockOpen ?
      reinterpret_cast<vbanapi::BlockOpenT *>(value) : nullptr;
  }
  const vbanapi::BlockOpenT *AsBlockOpen() const {
    return type == Block_BlockOpen ?
      reinterpret_cast<const vbanapi::BlockOpenT *>(value) : nullptr;
  }
  vbanapi::BlockReceiveT *AsBlockReceive() {
    return type == Block_BlockReceive ?
      reinterpret_cast<vbanapi::BlockReceiveT *>(value) : nullptr;
  }
  const vbanapi::BlockReceiveT *AsBlockReceive() const {
    return type == Block_BlockReceive ?
      reinterpret_cast<const vbanapi::BlockReceiveT *>(value) : nullptr;
  }
  vbanapi::BlockSendT *AsBlockSend() {
    return type == Block_BlockSend ?
      reinterpret_cast<vbanapi::BlockSendT *>(value) : nullptr;
  }
  const vbanapi::BlockSendT *AsBlockSend() const {
    return type == Block_BlockSend ?
      reinterpret_cast<const vbanapi::BlockSendT *>(value) : nullptr;
  }
  vbanapi::BlockChangeT *AsBlockChange() {
    return type == Block_BlockChange ?
      reinterpret_cast<vbanapi::BlockChangeT *>(value) : nullptr;
  }
  const vbanapi::BlockChangeT *AsBlockChange() const {
    return type == Block_BlockChange ?
      reinterpret_cast<const vbanapi::BlockChangeT *>(value) : nullptr;
  }
};
...
template<> struct MessageTraits<vbanapi::Error> {
  static const Message enum_value = Message_Error;
};

template<> struct MessageTraits<vbanapi::Success> {
  static const Message enum_value = Message_Success;
};

template<> struct MessageTraits<vbanapi::IsAlive> {
  static const Message enum_value = Message_IsAlive;
};

template<> struct MessageTraits<vbanapi::EventAck> {
  static const Message enum_value = Message_EventAck;
};

template<> struct MessageTraits<vbanapi::BlockInfo> {
  static const Message enum_value = Message_BlockInfo;
};

template<> struct MessageTraits<vbanapi::AccountWeight> {
  static const Message enum_value = Message_AccountWeight;
};

template<> struct MessageTraits<vbanapi::AccountWeightResponse> {
  static const Message enum_value = Message_AccountWeightResponse;
};

template<> struct MessageTraits<vbanapi::TopicConfirmation> {
  static const Message enum_value = Message_TopicConfirmation;
};

template<> struct MessageTraits<vbanapi::EventConfirmation> {
  static const Message enum_value = Message_EventConfirmation;
};

template<> struct MessageTraits<vbanapi::ServiceRegister> {
  static const Message enum_value = Message_ServiceRegister;
};

template<> struct MessageTraits<vbanapi::ServiceStop> {
  static const Message enum_value = Message_ServiceStop;
};

template<> struct MessageTraits<vbanapi::TopicServiceStop> {
  static const Message enum_value = Message_TopicServiceStop;
};

template<> struct MessageTraits<vbanapi::EventServiceStop> {
...
struct MessageUnion {
  ...
  vbanapi::ErrorT *AsError() {
    return type == Message_Error ?
      reinterpret_cast<vbanapi::ErrorT *>(value) : nullptr;
  }
  const vbanapi::ErrorT *AsError() const {
    return type == Message_Error ?
      reinterpret_cast<const vbanapi::ErrorT *>(value) : nullptr;
  }
  vbanapi::SuccessT *AsSuccess() {
    return type == Message_Success ?
      reinterpret_cast<vbanapi::SuccessT *>(value) : nullptr;
  }
  const vbanapi::SuccessT *AsSuccess() const {
    return type == Message_Success ?
      reinterpret_cast<const vbanapi::SuccessT *>(value) : nullptr;
  }
  vbanapi::IsAliveT *AsIsAlive() {
    return type == Message_IsAlive ?
      reinterpret_cast<vbanapi::IsAliveT *>(value) : nullptr;
  }
  const vbanapi::IsAliveT *AsIsAlive() const {
    return type == Message_IsAlive ?
      reinterpret_cast<const vbanapi::IsAliveT *>(value) : nullptr;
  }
  vbanapi::EventAckT *AsEventAck() {
    return type == Message_EventAck ?
      reinterpret_cast<vbanapi::EventAckT *>(value) : nullptr;
  }
  const vbanapi::EventAckT *AsEventAck() const {
    return type == Message_EventAck ?
      reinterpret_cast<const vbanapi::EventAckT *>(value) : nullptr;
  }
  vbanapi::BlockInfoT *AsBlockInfo() {
    return type == Message_BlockInfo ?
      reinterpret_cast<vbanapi::BlockInfoT *>(value) : nullptr;
  }
  const vbanapi::BlockInfoT *AsBlockInfo() const {
    return type == Message_BlockInfo ?
      reinterpret_cast<const vbanapi::BlockInfoT *>(value) : nullptr;
  }
  vbanapi::AccountWeightT *AsAccountWeight() {
    return type == Message_AccountWeight ?
      reinterpret_cast<vbanapi::AccountWeightT *>(value) : nullptr;
  }
  const vbanapi::AccountWeightT *AsAccountWeight() const {
    return type == Message_AccountWeight ?
      reinterpret_cast<const vbanapi::AccountWeightT *>(value) : nullptr;
  }
  vbanapi::AccountWeightResponseT *AsAccountWeightResponse() {
    return type == Message_AccountWeightResponse ?
      reinterpret_cast<vbanapi::AccountWeightResponseT *>(value) : nullptr;
  }
  const vbanapi::AccountWeightResponseT *AsAccountWeightResponse() const {
    return type == Message_AccountWeightResponse ?
      reinterpret_cast<const vbanapi::AccountWeightResponseT *>(value) : nullptr;
  }
  vbanapi::TopicConfirmationT *AsTopicConfirmation() {
    return type == Message_TopicConfirmation ?
      reinterpret_cast<vbanapi::TopicConfirmationT *>(value) : nullptr;
  }
  const vbanapi::TopicConfirmationT *AsTopicConfirmation() const {
    return type == Message_TopicConfirmation ?
      reinterpret_cast<const vbanapi::TopicConfirmationT *>(value) : nullptr;
  }
  vbanapi::EventConfirmationT *AsEventConfirmation() {
    return type == Message_EventConfirmation ?
      reinterpret_cast<vbanapi::EventConfirmationT *>(value) : nullptr;
  }
  const vbanapi::EventConfirmationT *AsEventConfirmation() const {
    return type == Message_EventConfirmation ?
      reinterpret_cast<const vbanapi::EventConfirmationT *>(value) : nullptr;
  }
  vbanapi::ServiceRegisterT *AsServiceRegister() {
    return type == Message_ServiceRegister ?
      reinterpret_cast<vbanapi::ServiceRegisterT *>(value) : nullptr;
  }
  const vbanapi::ServiceRegisterT *AsServiceRegister() const {
    return type == Message_ServiceRegister ?
      reinterpret_cast<const vbanapi::ServiceRegisterT *>(value) : nullptr;
  }
  vbanapi::ServiceStopT *AsServiceStop() {
    return type == Message_ServiceStop ?
      reinterpret_cast<vbanapi::ServiceStopT *>(value) : nullptr;
  }
  const vbanapi::ServiceStopT *AsServiceStop() const {
    return type == Message_ServiceStop ?
      reinterpret_cast<const vbanapi::ServiceStopT *>(value) : nullptr;
  }
  vbanapi::TopicServiceStopT *AsTopicServiceStop() {
    return type == Message_TopicServiceStop ?
      reinterpret_cast<vbanapi::TopicServiceStopT *>(value) : nullptr;
  }
  const vbanapi::TopicServiceStopT *AsTopicServiceStop() const {
    return type == Message_TopicServiceStop ?
      reinterpret_cast<const vbanapi::TopicServiceStopT *>(value) : nullptr;
  }
  vbanapi::EventServiceStopT *AsEventServiceStop() {
    return type == Message_EventServiceStop ?
      reinterpret_cast<vbanapi::EventServiceStopT *>(value) : nullptr;
  }
  const vbanapi::EventServiceStopT *AsEventServiceStop() const {
    return type == Message_EventServiceStop ?
      reinterpret_cast<const vbanapi::EventServiceStopT *>(value) : nullptr;
  }
};
...
inline flatbuffers::Offset<AccountWeight> CreateAccountWeightDirect(
  ...
  return vbanapi::CreateAccountWeight(
      _fbb,
      account__);
}
...
struct AccountWeightResponseT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vbanapi.AccountWeightResponseT";
  }
...
struct AccountWeightResponse FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vbanapi.AccountWeightResponse";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_VOTING_WEIGHT = 4
  };
...
inline flatbuffers::Offset<AccountWeightResponse> CreateAccountWeightResponseDirect(
  ...
  return vbanapi::CreateAccountWeightResponse(
      _fbb,
      voting_weight__);
}
...
inline flatbuffers::Offset<BlockOpen> CreateBlockOpenDirect(
  ...
  return vbanapi::CreateBlockOpen(
      _fbb,
      hash__,
      account__,
      source__,
...
inline flatbuffers::Offset<BlockReceive> CreateBlockReceiveDirect(
  ...
  auto signature__ = signature ? _fbb.CreateString(signature) : 0;
  auto work__ = work ? _fbb.CreateString(work) : 0;
  return vbanapi::CreateBlockReceive(
      _fbb,
      hash__,
      previous__,
      source__,
...
inline flatbuffers::Offset<BlockSend> CreateBlockSendDirect(
  ...
  auto signature__ = signature ? _fbb.CreateString(signature) : 0;
  auto work__ = work ? _fbb.CreateString(work) : 0;
  return vbanapi::CreateBlockSend(
      _fbb,
      hash__,
      previous__,
      destination__,
...
inline flatbuffers::Offset<BlockChange> CreateBlockChangeDirect(
  ...
  auto signature__ = signature ? _fbb.CreateString(signature) : 0;
  auto work__ = work ? _fbb.CreateString(work) : 0;
  return vbanapi::CreateBlockChange(
      _fbb,
      hash__,
      previous__,
      representative__,
...
struct BlockStateT : public flatbuffers::NativeTable {
  ...
  std::string signature;
  std::string work;
  vbanapi::BlockSubType subtype;
  BlockStateT()
      : subtype(vbanapi::BlockSubType_invalid) {
  }
};
...
struct BlockState FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  vbanapi::BlockSubType subtype() const {
    return static_cast<vbanapi::BlockSubType>(GetField<int8_t>(VT_SUBTYPE, 0));
  }
  bool mutate_subtype(vbanapi::BlockSubType _subtype) {
...
struct BlockStateBuilder {
  ...
  void add_subtype(vbanapi::BlockSubType subtype) {
...
inline flatbuffers::Offset<BlockState> CreateBlockState(
    ...
    flatbuffers::Offset<flatbuffers::String> signature = 0,
    flatbuffers::Offset<flatbuffers::String> work = 0,
    vbanapi::BlockSubType subtype = vbanapi::BlockSubType_invalid) {
...
inline flatbuffers::Offset<BlockState> CreateBlockStateDirect(
  ...
  auto signature__ = signature ? _fbb.CreateString(signature) : 0;
  auto work__ = work ? _fbb.CreateString(work) : 0;
  return vbanapi::CreateBlockState(
      _fbb,
      hash__,
      account__,
      previous__,
...
struct BlockInfo FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vbanapi.BlockInfo";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_BLOCK_TYPE = 4,
    VT_BLOCK = 6
  };
  vbanapi::Block block_type() const {
    return static_cast<vbanapi::Block>(GetField<uint8_t>(VT_BLOCK_TYPE, 0));
  }
  const void *block() const {
    return GetPointer<const void *>(VT_BLOCK);
  }
  template<typename T> const T *block_as() const;
  const vbanapi::BlockState *block_as_BlockState() const {
    return block_type() == vbanapi::Block_BlockState ? static_cast<const vbanapi::BlockState *>(block()) : nullptr;
  }
  const vbanapi::BlockOpen *block_as_BlockOpen() const {
    return block_type() == vbanapi::Block_BlockOpen ? static_cast<const vbanapi::BlockOpen *>(block()) : nullptr;
  }
  const vbanapi::BlockReceive *block_as_BlockReceive() const {
    return block_type() == vbanapi::Block_BlockReceive ? static_cast<const vbanapi::BlockReceive *>(block()) : nullptr;
  }
  const vbanapi::BlockSend *block_as_BlockSend() const {
    return block_type() == vbanapi::Block_BlockSend ? static_cast<const vbanapi::BlockSend *>(block()) : nullptr;
  }
  const vbanapi::BlockChange *block_as_BlockChange() const {
    return block_type() == vbanapi::Block_BlockChange ? static_cast<const vbanapi::BlockChange *>(block()) : nullptr;
  }
  void *mutable_block() {
...
template<> inline const vbanapi::BlockState *BlockInfo::block_as<vbanapi::BlockState>() const {
  return block_as_BlockState();
}

template<> inline const vbanapi::BlockOpen *BlockInfo::block_as<vbanapi::BlockOpen>() const {
  return block_as_BlockOpen();
}

template<> inline const vbanapi::BlockReceive *BlockInfo::block_as<vbanapi::BlockReceive>() const {
  return block_as_BlockReceive();
}

template<> inline const vbanapi::BlockSend *BlockInfo::block_as<vbanapi::BlockSend>() const {
  return block_as_BlockSend();
}

template<> inline const vbanapi::BlockChange *BlockInfo::block_as<vbanapi::BlockChange>() const {
...
struct BlockInfoBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_block_type(vbanapi::Block block_type) {
...
inline flatbuffers::Offset<BlockInfo> CreateBlockInfo(
    flatbuffers::FlatBufferBuilder &_fbb,
    vbanapi::Block block_type = vbanapi::Block_NONE,
...
struct ServiceRegisterT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vbanapi.ServiceRegisterT";
  }
...
struct ServiceRegister FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vbanapi.ServiceRegister";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_SERVICE_NAME = 4
  };
...
inline flatbuffers::Offset<ServiceRegister> CreateServiceRegisterDirect(
  ...
  return vbanapi::CreateServiceRegister(
      _fbb,
      service_name__);
}
...
inline flatbuffers::Offset<ServiceStop> CreateServiceStopDirect(
    ...
    bool restart = false) {
  auto service_name__ = service_name ? _fbb.CreateString(service_name) : 0;
  return vbanapi::CreateServiceStop(
      _fbb,
      service_name__,
      restart);
}
...
struct TopicServiceStopT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vbanapi.TopicServiceStopT";
  }
  bool unsubscribe;
  TopicServiceStopT()
      : unsubscribe(false) {
...
struct TopicServiceStop FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vbanapi.TopicServiceStop";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_UNSUBSCRIBE = 4
  };
...
struct EventServiceStopT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vbanapi.EventServiceStopT";
  }
  EventServiceStopT() {
  }
};
...
struct EventServiceStop FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vbanapi.EventServiceStop";
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           verifier.EndTable();
...
struct TopicConfirmationT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vbanapi.TopicConfirmationT";
  }
  bool unsubscribe;
  std::unique_ptr<vbanapi::TopicConfirmationOptionsT> options;
  TopicConfirmationT()
      : unsubscribe(false) {
  }
};
...
struct TopicConfirmation FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vbanapi.TopicConfirmation";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_UNSUBSCRIBE = 4,
    VT_OPTIONS = 6
  ...
  const vbanapi::TopicConfirmationOptions *options() const {
    return GetPointer<const vbanapi::TopicConfirmationOptions *>(VT_OPTIONS);
  }
  vbanapi::TopicConfirmationOptions *mutable_options() {
    return GetPointer<vbanapi::TopicConfirmationOptions *>(VT_OPTIONS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint8_t>(verifier, VT_UNSUBSCRIBE) &&
...
struct TopicConfirmationBuilder {
  ...
  void add_options(flatbuffers::Offset<vbanapi::TopicConfirmationOptions> options) {
...
inline flatbuffers::Offset<TopicConfirmation> CreateTopicConfirmation(
    flatbuffers::FlatBufferBuilder &_fbb,
    bool unsubscribe = false,
    flatbuffers::Offset<vbanapi::TopicConfirmationOptions> options = 0) {
...
struct TopicConfirmationOptionsT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vbanapi.TopicConfirmationOptionsT";
  }
  vbanapi::TopicConfirmationTypeFilter confirmation_type_filter;
  bool all_local_accounts;
  std::vector<std::string> accounts;
  bool include_block;
  bool include_election_info;
  TopicConfirmationOptionsT()
      : confirmation_type_filter(vbanapi::TopicConfirmationTypeFilter_all),
...
struct TopicConfirmationOptions FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vbanapi.TopicConfirmationOptions";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
  ...
  vbanapi::TopicConfirmationTypeFilter confirmation_type_filter() const {
    return static_cast<vbanapi::TopicConfirmationTypeFilter>(GetField<int8_t>(VT_CONFIRMATION_TYPE_FILTER, 0));
  }
  bool mutate_confirmation_type_filter(vbanapi::TopicConfirmationTypeFilter _confirmation_type_filter) {
...
struct TopicConfirmationOptionsBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_confirmation_type_filter(vbanapi::TopicConfirmationTypeFilter confirmation_type_filter) {
...
inline flatbuffers::Offset<TopicConfirmationOptions> CreateTopicConfirmationOptions(
    flatbuffers::FlatBufferBuilder &_fbb,
    vbanapi::TopicConfirmationTypeFilter confirmation_type_filter = vbanapi::TopicConfirmationTypeFilter_all,
...
inline flatbuffers::Offset<TopicConfirmationOptions> CreateTopicConfirmationOptionsDirect(
  ...
  return vbanapi::CreateTopicConfirmationOptions(
      _fbb,
...
struct EventConfirmationT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vbanapi.EventConfirmationT";
  }
  vbanapi::TopicConfirmationType confirmation_type;
  std::string account;
  std::string amount;
  std::string hash;
  vbanapi::BlockUnion block;
  std::unique_ptr<vbanapi::ElectionInfoT> election_info;
  EventConfirmationT()
      : confirmation_type(vbanapi::TopicConfirmationType_active_quorum) {
  }
};
...
struct EventConfirmation FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vbanapi.EventConfirmation";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
  ...
  vbanapi::TopicConfirmationType confirmation_type() const {
    return static_cast<vbanapi::TopicConfirmationType>(GetField<int8_t>(VT_CONFIRMATION_TYPE, 0));
  }
  bool mutate_confirmation_type(vbanapi::TopicConfirmationType _confirmation_type) {
  ...
  const vbanapi::ElectionInfo *election_info() const {
    return GetPointer<const vbanapi::ElectionInfo *>(VT_ELECTION_INFO);
  }
  vbanapi::ElectionInfo *mutable_election_info() {
    return GetPointer<vbanapi::ElectionInfo *>(VT_ELECTION_INFO);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
template<> inline const vbanapi::BlockState *EventConfirmation::block_as<vbanapi::BlockState>() const {
  return block_as_BlockState();
}

template<> inline const vbanapi::BlockOpen *EventConfirmation::block_as<vbanapi::BlockOpen>() const {
  return block_as_BlockOpen();
}

template<> inline const vbanapi::BlockReceive *EventConfirmation::block_as<vbanapi::BlockReceive>() const {
  return block_as_BlockReceive();
}

template<> inline const vbanapi::BlockSend *EventConfirmation::block_as<vbanapi::BlockSend>() const {
  return block_as_BlockSend();
}

template<> inline const vbanapi::BlockChange *EventConfirmation::block_as<vbanapi::BlockChange>() const {
  return block_as_BlockChange();
}
...
struct EventConfirmationBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_confirmation_type(vbanapi::TopicConfirmationType confirmation_type) {
  ...
  void add_election_info(flatbuffers::Offset<vbanapi::ElectionInfo> election_info) {
...
inline flatbuffers::Offset<EventConfirmation> CreateEventConfirmation(
    flatbuffers::FlatBufferBuilder &_fbb,
    vbanapi::TopicConfirmationType confirmation_type = vbanapi::TopicConfirmationType_active_quorum,
    flatbuffers::Offset<flatbuffers::String> account = 0,
    flatbuffers::Offset<flatbuffers::String> amount = 0,
    flatbuffers::Offset<flatbuffers::String> hash = 0,
    vbanapi::Block block_type = vbanapi::Block_NONE,
    flatbuffers::Offset<void> block = 0,
    flatbuffers::Offset<vbanapi::ElectionInfo> election_info = 0) {
...
inline flatbuffers::Offset<EventConfirmation> CreateEventConfirmationDirect(
  ...
  auto hash__ = hash ? _fbb.CreateString(hash) : 0;
  return vbanapi::CreateEventConfirmation(
      _fbb,
      confirmation_type,
      account__,
      amount__,
...
inline flatbuffers::Offset<ElectionInfo> CreateElectionInfoDirect(
  ...
  return vbanapi::CreateElectionInfo(
      _fbb,
      duration,
      time,
      tally__,
...
struct EnvelopeT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vbanapi.EnvelopeT";
  }
  uint64_t time;
  std::string credentials;
  std::string correlation_id;
  vbanapi::MessageUnion message;
  EnvelopeT()
      : time(0) {
  }
};
...
struct Envelope FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  vbanapi::Message message_type() const {
    return static_cast<vbanapi::Message>(GetField<uint8_t>(VT_MESSAGE_TYPE, 0));
  }
  const void *message() const {
    return GetPointer<const void *>(VT_MESSAGE);
  }
  template<typename T> const T *message_as() const;
  const vbanapi::Error *message_as_Error() const {
    return message_type() == vbanapi::Message_Error ? static_cast<const vbanapi::Error *>(message()) : nullptr;
  }
  const vbanapi::Success *message_as_Success() const {
    return message_type() == vbanapi::Message_Success ? static_cast<const vbanapi::Success *>(message()) : nullptr;
  }
  const vbanapi::IsAlive *message_as_IsAlive() const {
    return message_type() == vbanapi::Message_IsAlive ? static_cast<const vbanapi::IsAlive *>(message()) : nullptr;
  }
  const vbanapi::EventAck *message_as_EventAck() const {
    return message_type() == vbanapi::Message_EventAck ? static_cast<const vbanapi::EventAck *>(message()) : nullptr;
  }
  const vbanapi::BlockInfo *message_as_BlockInfo() const {
    return message_type() == vbanapi::Message_BlockInfo ? static_cast<const vbanapi::BlockInfo *>(message()) : nullptr;
  }
  const vbanapi::AccountWeight *message_as_AccountWeight() const {
    return message_type() == vbanapi::Message_AccountWeight ? static_cast<const vbanapi::AccountWeight *>(message()) : nullptr;
  }
  const vbanapi::AccountWeightResponse *message_as_AccountWeightResponse() const {
    return message_type() == vbanapi::Message_AccountWeightResponse ? static_cast<const vbanapi::AccountWeightResponse *>(message()) : nullptr;
  }
  const vbanapi::TopicConfirmation *message_as_TopicConfirmation() const {
    return message_type() == vbanapi::Message_TopicConfirmation ? static_cast<const vbanapi::TopicConfirmation *>(message()) : nullptr;
  }
  const vbanapi::EventConfirmation *message_as_EventConfirmation() const {
    return message_type() == vbanapi::Message_EventConfirmation ? static_cast<const vbanapi::EventConfirmation *>(message()) : nullptr;
  }
  const vbanapi::ServiceRegister *message_as_ServiceRegister() const {
    return message_type() == vbanapi::Message_ServiceRegister ? static_cast<const vbanapi::ServiceRegister *>(message()) : nullptr;
  }
  const vbanapi::ServiceStop *message_as_ServiceStop() const {
    return message_type() == vbanapi::Message_ServiceStop ? static_cast<const vbanapi::ServiceStop *>(message()) : nullptr;
  }
  const vbanapi::TopicServiceStop *message_as_TopicServiceStop() const {
    return message_type() == vbanapi::Message_TopicServiceStop ? static_cast<const vbanapi::TopicServiceStop *>(message()) : nullptr;
  }
  const vbanapi::EventServiceStop *message_as_EventServiceStop() const {
    return message_type() == vbanapi::Message_EventServiceStop ? static_cast<const vbanapi::EventServiceStop *>(message()) : nullptr;
  }
...
template<> inline const vbanapi::Error *Envelope::message_as<vbanapi::Error>() const {
  return message_as_Error();
}

template<> inline const vbanapi::Success *Envelope::message_as<vbanapi::Success>() const {
  return message_as_Success();
}

template<> inline const vbanapi::IsAlive *Envelope::message_as<vbanapi::IsAlive>() const {
  return message_as_IsAlive();
}

template<> inline const vbanapi::EventAck *Envelope::message_as<vbanapi::EventAck>() const {
  return message_as_EventAck();
}

template<> inline const vbanapi::BlockInfo *Envelope::message_as<vbanapi::BlockInfo>() const {
  return message_as_BlockInfo();
}

template<> inline const vbanapi::AccountWeight *Envelope::message_as<vbanapi::AccountWeight>() const {
  return message_as_AccountWeight();
}

template<> inline const vbanapi::AccountWeightResponse *Envelope::message_as<vbanapi::AccountWeightResponse>() const {
  return message_as_AccountWeightResponse();
}

template<> inline const vbanapi::TopicConfirmation *Envelope::message_as<vbanapi::TopicConfirmation>() const {
  return message_as_TopicConfirmation();
}

template<> inline const vbanapi::EventConfirmation *Envelope::message_as<vbanapi::EventConfirmation>() const {
  return message_as_EventConfirmation();
}

template<> inline const vbanapi::ServiceRegister *Envelope::message_as<vbanapi::ServiceRegister>() const {
  return message_as_ServiceRegister();
}

template<> inline const vbanapi::ServiceStop *Envelope::message_as<vbanapi::ServiceStop>() const {
  return message_as_ServiceStop();
}

template<> inline const vbanapi::TopicServiceStop *Envelope::message_as<vbanapi::TopicServiceStop>() const {
  return message_as_TopicServiceStop();
}

template<> inline const vbanapi::EventServiceStop *Envelope::message_as<vbanapi::EventServiceStop>() const {
...
struct EnvelopeBuilder {
  ...
  void add_message_type(vbanapi::Message message_type) {
...
inline flatbuffers::Offset<Envelope> CreateEnvelope(
    ...
    vbanapi::Message message_type = vbanapi::Message_NONE,
...
inline void BlockInfo::UnPackTo(BlockInfoT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = block(); if (_e) _o->block.value = vbanapi::BlockUnion::UnPack(_e, block_type(), _resolver); }
}
...
inline flatbuffers::Offset<BlockInfo> CreateBlockInfo(flatbuffers::FlatBufferBuilder &_fbb, const BlockInfoT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return vbanapi::CreateBlockInfo(
      _fbb,
      _block_type,
      _block);
}
...
inline flatbuffers::Offset<TopicServiceStop> CreateTopicServiceStop(flatbuffers::FlatBufferBuilder &_fbb, const TopicServiceStopT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return vbanapi::CreateTopicServiceStop(
      _fbb,
      _unsubscribe);
}
...
inline flatbuffers::Offset<EventServiceStop> CreateEventServiceStop(flatbuffers::FlatBufferBuilder &_fbb, const EventServiceStopT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return vbanapi::CreateEventServiceStop(
      _fbb);
}
...
inline void TopicConfirmation::UnPackTo(TopicConfirmationT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  (void)_resolver;
  { auto _e = unsubscribe(); _o->unsubscribe = _e; }
  { auto _e = options(); if (_e) _o->options = std::unique_ptr<vbanapi::TopicConfirmationOptionsT>(_e->UnPack(_resolver)); }
}
...
inline flatbuffers::Offset<TopicConfirmation> CreateTopicConfirmation(flatbuffers::FlatBufferBuilder &_fbb, const TopicConfirmationT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return vbanapi::CreateTopicConfirmation(
      _fbb,
      _unsubscribe,
      _options);
}
...
inline void EventConfirmation::UnPackTo(EventConfirmationT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = block_type(); _o->block.type = _e; }
  { auto _e = block(); if (_e) _o->block.value = vbanapi::BlockUnion::UnPack(_e, block_type(), _resolver); }
  { auto _e = election_info(); if (_e) _o->election_info = std::unique_ptr<vbanapi::ElectionInfoT>(_e->UnPack(_resolver)); }
}
...
inline void Envelope::UnPackTo(EnvelopeT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = message(); if (_e) _o->message.value = vbanapi::MessageUnion::UnPack(_e, message_type(), _resolver); }
}
...
inline bool VerifyBlock(flatbuffers::Verifier &verifier, const void *obj, Block type) {
  switch (type) {
    ...
    case Block_BlockState: {
      auto ptr = reinterpret_cast<const vbanapi::BlockState *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Block_BlockOpen: {
      auto ptr = reinterpret_cast<const vbanapi::BlockOpen *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Block_BlockReceive: {
      auto ptr = reinterpret_cast<const vbanapi::BlockReceive *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Block_BlockSend: {
      auto ptr = reinterpret_cast<const vbanapi::BlockSend *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Block_BlockChange: {
      auto ptr = reinterpret_cast<const vbanapi::BlockChange *>(obj);
      return verifier.VerifyTable(ptr);
    }
    default: return true;
  }
...
inline flatbuffers::Offset<void> BlockUnion::Pack(flatbuffers::FlatBufferBuilder &_fbb, const flatbuffers::rehasher_function_t *_rehasher) const {
  switch (type) {
    case Block_BlockState: {
      auto ptr = reinterpret_cast<const vbanapi::BlockStateT *>(value);
      return CreateBlockState(_fbb, ptr, _rehasher).Union();
    }
    case Block_BlockOpen: {
      auto ptr = reinterpret_cast<const vbanapi::BlockOpenT *>(value);
      return CreateBlockOpen(_fbb, ptr, _rehasher).Union();
    }
    case Block_BlockReceive: {
      auto ptr = reinterpret_cast<const vbanapi::BlockReceiveT *>(value);
      return CreateBlockReceive(_fbb, ptr, _rehasher).Union();
    }
    case Block_BlockSend: {
      auto ptr = reinterpret_cast<const vbanapi::BlockSendT *>(value);
      return CreateBlockSend(_fbb, ptr, _rehasher).Union();
    }
    case Block_BlockChange: {
      auto ptr = reinterpret_cast<const vbanapi::BlockChangeT *>(value);
...
inline BlockUnion::BlockUnion(const BlockUnion &u) FLATBUFFERS_NOEXCEPT : type(u.type), value(nullptr) {
  switch (type) {
    case Block_BlockState: {
      value = new vbanapi::BlockStateT(*reinterpret_cast<vbanapi::BlockStateT *>(u.value));
      break;
    }
    case Block_BlockOpen: {
      value = new vbanapi::BlockOpenT(*reinterpret_cast<vbanapi::BlockOpenT *>(u.value));
      break;
    }
    case Block_BlockReceive: {
      value = new vbanapi::BlockReceiveT(*reinterpret_cast<vbanapi::BlockReceiveT *>(u.value));
      break;
    }
    case Block_BlockSend: {
      value = new vbanapi::BlockSendT(*reinterpret_cast<vbanapi::BlockSendT *>(u.value));
      break;
    }
    case Block_BlockChange: {
      value = new vbanapi::BlockChangeT(*reinterpret_cast<vbanapi::BlockChangeT *>(u.value));
      break;
    }
    default:
      break;
...
inline void BlockUnion::Reset() {
  switch (type) {
    case Block_BlockState: {
      auto ptr = reinterpret_cast<vbanapi::BlockStateT *>(value);
      delete ptr;
      break;
    }
    case Block_BlockOpen: {
      auto ptr = reinterpret_cast<vbanapi::BlockOpenT *>(value);
      delete ptr;
      break;
    }
    case Block_BlockReceive: {
      auto ptr = reinterpret_cast<vbanapi::BlockReceiveT *>(value);
      delete ptr;
      break;
    }
    case Block_BlockSend: {
      auto ptr = reinterpret_cast<vbanapi::BlockSendT *>(value);
      delete ptr;
      break;
    }
    case Block_BlockChange: {
      auto ptr = reinterpret_cast<vbanapi::BlockChangeT *>(value);
      delete ptr;
      break;
    }
    default: break;
...
inline bool VerifyMessage(flatbuffers::Verifier &verifier, const void *obj, Message type) {
  switch (type) {
    ...
    case Message_Error: {
      auto ptr = reinterpret_cast<const vbanapi::Error *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_Success: {
      auto ptr = reinterpret_cast<const vbanapi::Success *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_IsAlive: {
      auto ptr = reinterpret_cast<const vbanapi::IsAlive *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_EventAck: {
      auto ptr = reinterpret_cast<const vbanapi::EventAck *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_BlockInfo: {
      auto ptr = reinterpret_cast<const vbanapi::BlockInfo *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_AccountWeight: {
      auto ptr = reinterpret_cast<const vbanapi::AccountWeight *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_AccountWeightResponse: {
      auto ptr = reinterpret_cast<const vbanapi::AccountWeightResponse *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_TopicConfirmation: {
      auto ptr = reinterpret_cast<const vbanapi::TopicConfirmation *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_EventConfirmation: {
      auto ptr = reinterpret_cast<const vbanapi::EventConfirmation *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_ServiceRegister: {
      auto ptr = reinterpret_cast<const vbanapi::ServiceRegister *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_ServiceStop: {
      auto ptr = reinterpret_cast<const vbanapi::ServiceStop *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_TopicServiceStop: {
      auto ptr = reinterpret_cast<const vbanapi::TopicServiceStop *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_EventServiceStop: {
      auto ptr = reinterpret_cast<const vbanapi::EventServiceStop *>(obj);
      return verifier.VerifyTable(ptr);
    }
    default: return true;
  }
...
inline flatbuffers::Offset<void> MessageUnion::Pack(flatbuffers::FlatBufferBuilder &_fbb, const flatbuffers::rehasher_function_t *_rehasher) const {
  switch (type) {
    case Message_Error: {
      auto ptr = reinterpret_cast<const vbanapi::ErrorT *>(value);
      return CreateError(_fbb, ptr, _rehasher).Union();
    }
    case Message_Success: {
      auto ptr = reinterpret_cast<const vbanapi::SuccessT *>(value);
      return CreateSuccess(_fbb, ptr, _rehasher).Union();
    }
    case Message_IsAlive: {
      auto ptr = reinterpret_cast<const vbanapi::IsAliveT *>(value);
      return CreateIsAlive(_fbb, ptr, _rehasher).Union();
    }
    case Message_EventAck: {
      auto ptr = reinterpret_cast<const vbanapi::EventAckT *>(value);
      return CreateEventAck(_fbb, ptr, _rehasher).Union();
    }
    case Message_BlockInfo: {
      auto ptr = reinterpret_cast<const vbanapi::BlockInfoT *>(value);
      return CreateBlockInfo(_fbb, ptr, _rehasher).Union();
    }
    case Message_AccountWeight: {
      auto ptr = reinterpret_cast<const vbanapi::AccountWeightT *>(value);
      return CreateAccountWeight(_fbb, ptr, _rehasher).Union();
    }
    case Message_AccountWeightResponse: {
      auto ptr = reinterpret_cast<const vbanapi::AccountWeightResponseT *>(value);
      return CreateAccountWeightResponse(_fbb, ptr, _rehasher).Union();
    }
    case Message_TopicConfirmation: {
      auto ptr = reinterpret_cast<const vbanapi::TopicConfirmationT *>(value);
      return CreateTopicConfirmation(_fbb, ptr, _rehasher).Union();
    }
    case Message_EventConfirmation: {
      auto ptr = reinterpret_cast<const vbanapi::EventConfirmationT *>(value);
      return CreateEventConfirmation(_fbb, ptr, _rehasher).Union();
    }
    case Message_ServiceRegister: {
      auto ptr = reinterpret_cast<const vbanapi::ServiceRegisterT *>(value);
      return CreateServiceRegister(_fbb, ptr, _rehasher).Union();
    }
    case Message_ServiceStop: {
      auto ptr = reinterpret_cast<const vbanapi::ServiceStopT *>(value);
      return CreateServiceStop(_fbb, ptr, _rehasher).Union();
    }
    case Message_TopicServiceStop: {
      auto ptr = reinterpret_cast<const vbanapi::TopicServiceStopT *>(value);
      return CreateTopicServiceStop(_fbb, ptr, _rehasher).Union();
    }
    case Message_EventServiceStop: {
      auto ptr = reinterpret_cast<const vbanapi::EventServiceStopT *>(value);
...
inline MessageUnion::MessageUnion(const MessageUnion &u) FLATBUFFERS_NOEXCEPT : type(u.type), value(nullptr) {
  switch (type) {
    case Message_Error: {
      value = new vbanapi::ErrorT(*reinterpret_cast<vbanapi::ErrorT *>(u.value));
      break;
    }
    case Message_Success: {
      value = new vbanapi::SuccessT(*reinterpret_cast<vbanapi::SuccessT *>(u.value));
      break;
    }
    case Message_IsAlive: {
      value = new vbanapi::IsAliveT(*reinterpret_cast<vbanapi::IsAliveT *>(u.value));
      break;
    }
    case Message_EventAck: {
      value = new vbanapi::EventAckT(*reinterpret_cast<vbanapi::EventAckT *>(u.value));
      break;
    }
    case Message_BlockInfo: {
      value = new vbanapi::BlockInfoT(*reinterpret_cast<vbanapi::BlockInfoT *>(u.value));
      break;
    }
    case Message_AccountWeight: {
      value = new vbanapi::AccountWeightT(*reinterpret_cast<vbanapi::AccountWeightT *>(u.value));
      break;
    }
    case Message_AccountWeightResponse: {
      value = new vbanapi::AccountWeightResponseT(*reinterpret_cast<vbanapi::AccountWeightResponseT *>(u.value));
      break;
    }
    case Message_TopicConfirmation: {
      FLATBUFFERS_ASSERT(false);  // vbanapi::TopicConfirmationT not copyable.
      break;
    }
    case Message_EventConfirmation: {
      FLATBUFFERS_ASSERT(false);  // vbanapi::EventConfirmationT not copyable.
      break;
    }
    case Message_ServiceRegister: {
      value = new vbanapi::ServiceRegisterT(*reinterpret_cast<vbanapi::ServiceRegisterT *>(u.value));
      break;
    }
    case Message_ServiceStop: {
      value = new vbanapi::ServiceStopT(*reinterpret_cast<vbanapi::ServiceStopT *>(u.value));
      break;
    }
    case Message_TopicServiceStop: {
      value = new vbanapi::TopicServiceStopT(*reinterpret_cast<vbanapi::TopicServiceStopT *>(u.value));
      break;
    }
    case Message_EventServiceStop: {
      value = new vbanapi::EventServiceStopT(*reinterpret_cast<vbanapi::EventServiceStopT *>(u.value));
      break;
    }
    default:
      break;
...
inline void MessageUnion::Reset() {
  switch (type) {
    case Message_Error: {
      auto ptr = reinterpret_cast<vbanapi::ErrorT *>(value);
      delete ptr;
      break;
    }
    case Message_Success: {
      auto ptr = reinterpret_cast<vbanapi::SuccessT *>(value);
      delete ptr;
      break;
    }
    case Message_IsAlive: {
      auto ptr = reinterpret_cast<vbanapi::IsAliveT *>(value);
      delete ptr;
      break;
    }
    case Message_EventAck: {
      auto ptr = reinterpret_cast<vbanapi::EventAckT *>(value);
      delete ptr;
      break;
    }
    case Message_BlockInfo: {
      auto ptr = reinterpret_cast<vbanapi::BlockInfoT *>(value);
      delete ptr;
      break;
    }
    case Message_AccountWeight: {
      auto ptr = reinterpret_cast<vbanapi::AccountWeightT *>(value);
      delete ptr;
      break;
    }
    case Message_AccountWeightResponse: {
      auto ptr = reinterpret_cast<vbanapi::AccountWeightResponseT *>(value);
      delete ptr;
      break;
    }
    case Message_TopicConfirmation: {
      auto ptr = reinterpret_cast<vbanapi::TopicConfirmationT *>(value);
      delete ptr;
      break;
    }
    case Message_EventConfirmation: {
      auto ptr = reinterpret_cast<vbanapi::EventConfirmationT *>(value);
      delete ptr;
      break;
    }
    case Message_ServiceRegister: {
      auto ptr = reinterpret_cast<vbanapi::ServiceRegisterT *>(value);
      delete ptr;
      break;
    }
    case Message_ServiceStop: {
      auto ptr = reinterpret_cast<vbanapi::ServiceStopT *>(value);
      delete ptr;
      break;
    }
    case Message_TopicServiceStop: {
      auto ptr = reinterpret_cast<vbanapi::TopicServiceStopT *>(value);
      delete ptr;
      break;
    }
    case Message_EventServiceStop: {
      auto ptr = reinterpret_cast<vbanapi::EventServiceStopT *>(value);
      delete ptr;
      break;
    }
    default: break;
...
inline const flatbuffers::TypeTable *BlockTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    vbanapi::BlockStateTypeTable,
    vbanapi::BlockOpenTypeTable,
    vbanapi::BlockReceiveTypeTable,
    vbanapi::BlockSendTypeTable,
    vbanapi::BlockChangeTypeTable
  };
  static const char * const names[] = {
    "NONE",
    "BlockState",
...
inline const flatbuffers::TypeTable *TopicConfirmationTypeFilterTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    vbanapi::TopicConfirmationTypeFilterTypeTable
  };
  static const char * const names[] = {
    "all",
    "active",
...
inline const flatbuffers::TypeTable *TopicConfirmationTypeTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    vbanapi::TopicConfirmationTypeTypeTable
  };
  static const char * const names[] = {
    "active_quorum",
    "active_confirmation_height",
...
inline const flatbuffers::TypeTable *MessageTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    vbanapi::ErrorTypeTable,
    vbanapi::SuccessTypeTable,
    vbanapi::IsAliveTypeTable,
    vbanapi::EventAckTypeTable,
    vbanapi::BlockInfoTypeTable,
    vbanapi::AccountWeightTypeTable,
    vbanapi::AccountWeightResponseTypeTable,
    vbanapi::TopicConfirmationTypeTable,
    vbanapi::EventConfirmationTypeTable,
    vbanapi::ServiceRegisterTypeTable,
    vbanapi::ServiceStopTypeTable,
    vbanapi::TopicServiceStopTypeTable,
    vbanapi::EventServiceStopTypeTable
  };
  static const char * const names[] = {
    "NONE",
    "Error",
...
inline const flatbuffers::TypeTable *TopicConfirmationTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    vbanapi::TopicConfirmationOptionsTypeTable
  };
  static const char * const names[] = {
    "unsubscribe",
    "options"
...
inline const vbanapi::Envelope *GetEnvelope(const void *buf) {
  return flatbuffers::GetRoot<vbanapi::Envelope>(buf);
}

inline const vbanapi::Envelope *GetSizePrefixedEnvelope(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<vbanapi::Envelope>(buf);
}
...
inline bool VerifyEnvelopeBuffer(
  ...
  return verifier.VerifyBuffer<vbanapi::Envelope>(nullptr);
}

inline bool VerifySizePrefixedEnvelopeBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<vbanapi::Envelope>(nullptr);
}

inline void FinishEnvelopeBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<vbanapi::Envelope> root) {
  fbb.Finish(root);
}
...
inline std::unique_ptr<vbanapi::EnvelopeT> UnPackEnvelope(
    const void *buf,
    const flatbuffers::resolver_function_t *res = nullptr) {
  return std::unique_ptr<vbanapi::EnvelopeT>(GetEnvelope(buf)->UnPack(res));
}

inline std::unique_ptr<vbanapi::EnvelopeT> UnPackSizePrefixedEnvelope(
    const void *buf,
    const flatbuffers::resolver_function_t *res = nullptr) {
  return std::unique_ptr<vbanapi::EnvelopeT>(GetSizePrefixedEnvelope(buf)->UnPack(res));
}

}  // namespace vbanapi

#endif  // FLATBUFFERS_GENERATED_VBANAPI_VBANAPI_H_
