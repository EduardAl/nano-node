...
std::vector<std::string> vban::config_overrides (std::vector<config_key_value_pair> const & key_value_pairs_a)
{
...
std::istream & vban::operator>> (std::istream & is, vban::config_key_value_pair & into)
{
	char ch;
	while (is >> ch && ch != '=')
	{
