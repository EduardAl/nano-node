...
{
/**
 * Specialization of vban::rpc with TLS support
 */
class rpc_secure : public rpc
{
public:
	rpc_secure (boost::asio::io_context & context_a, vban::rpc_config const & config_a, vban::rpc_handler_interface & rpc_handler_interface_a);
