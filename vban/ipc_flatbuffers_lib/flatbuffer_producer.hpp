...
namespace ipc
{
	/** Produces Vban API compliant Flatbuffers from objects and builders */
	...
	public:
		...
		{
			vban::ipc::flatbuffer_producer producer;
		...
		auto make_envelope (flatbuffers::Offset<T> obj)
		{
			...
			vbanapi::EnvelopeBuilder envelope_builder (*fbb);
			...
			envelope_builder.add_message_type (vbanapi::MessageTraits<T>::enum_value);
