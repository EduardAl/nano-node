...
TEST (peer_container, empty_peers)
{
	...
	vban::network & network (system.nodes[0]->network);
...
TEST (peer_container, no_recontact)
{
	...
	vban::network & network (node1.network);
	auto observed_peer (0);
	auto observed_disconnect (false);
	vban::endpoint endpoint1 (boost::asio::ip::address_v6::loopback (), 10000);
	ASSERT_EQ (0, network.size ());
	network.channel_observer = [&observed_peer] (std::shared_ptr<vban::transport::channel> const &) { ++observed_peer; };
...
TEST (peer_container, reserved_peers_no_contact)
{
	...
	ASSERT_EQ (nullptr, channels.insert (vban::endpoint (boost::asio::ip::address_v6::v4_mapped (boost::asio::ip::address_v4 (0x00000001)), 10000), 0));
	ASSERT_EQ (nullptr, channels.insert (vban::endpoint (boost::asio::ip::address_v6::v4_mapped (boost::asio::ip::address_v4 (0xc0000201)), 10000), 0));
	ASSERT_EQ (nullptr, channels.insert (vban::endpoint (boost::asio::ip::address_v6::v4_mapped (boost::asio::ip::address_v4 (0xc6336401)), 10000), 0));
	ASSERT_EQ (nullptr, channels.insert (vban::endpoint (boost::asio::ip::address_v6::v4_mapped (boost::asio::ip::address_v4 (0xcb007101)), 10000), 0));
	ASSERT_EQ (nullptr, channels.insert (vban::endpoint (boost::asio::ip::address_v6::v4_mapped (boost::asio::ip::address_v4 (0xe9fc0001)), 10000), 0));
	ASSERT_EQ (nullptr, channels.insert (vban::endpoint (boost::asio::ip::address_v6::v4_mapped (boost::asio::ip::address_v4 (0xf0000001)), 10000), 0));
	ASSERT_EQ (nullptr, channels.insert (vban::endpoint (boost::asio::ip::address_v6::v4_mapped (boost::asio::ip::address_v4 (0xffffffff)), 10000), 0));
...
TEST (peer_container, split)
{
	...
	vban::endpoint endpoint1 (boost::asio::ip::address_v6::loopback (), 100);
	vban::endpoint endpoint2 (boost::asio::ip::address_v6::loopback (), 101);
...
{
	vban::system system (1);
	std::array<vban::endpoint, 8> target;
	std::fill (target.begin (), target.end (), vban::endpoint (boost::asio::ip::address_v6::loopback (), 10000));
	system.nodes[0]->network.random_fill (target);
	ASSERT_TRUE (std::all_of (target.begin (), target.end (), [] (vban::endpoint const & endpoint_a) { return endpoint_a == vban::endpoint (boost::asio::ip::address_v6::any (), 0); }));
}
...
TEST (channels, fill_random_full)
{
	...
	{
		system.nodes[0]->network.udp_channels.insert (vban::endpoint (boost::asio::ip::address_v6::loopback (), i), 0);
	}
	std::array<vban::endpoint, 8> target;
	std::fill (target.begin (), target.end (), vban::endpoint (boost::asio::ip::address_v6::loopback (), 10000));
	system.nodes[0]->network.random_fill (target);
	ASSERT_TRUE (std::none_of (target.begin (), target.end (), [] (vban::endpoint const & endpoint_a) { return endpoint_a == vban::endpoint (boost::asio::ip::address_v6::loopback (), 10000); }));
}
...
TEST (channels, fill_random_part)
{
	...
	{
		system.nodes[0]->network.udp_channels.insert (vban::endpoint (boost::asio::ip::address_v6::loopback (), i + 1), 0);
	}
	std::fill (target.begin (), target.end (), vban::endpoint (boost::asio::ip::address_v6::loopback (), 10000));
	system.nodes[0]->network.random_fill (target);
	ASSERT_TRUE (std::none_of (target.begin (), target.begin () + half, [] (vban::endpoint const & endpoint_a) { return endpoint_a == vban::endpoint (boost::asio::ip::address_v6::loopback (), 10000); }));
	ASSERT_TRUE (std::none_of (target.begin (), target.begin () + half, [] (vban::endpoint const & endpoint_a) { return endpoint_a == vban::endpoint (boost::asio::ip::address_v6::loopback (), 0); }));
	ASSERT_TRUE (std::all_of (target.begin () + half, target.end (), [] (vban::endpoint const & endpoint_a) { return endpoint_a == vban::endpoint (boost::asio::ip::address_v6::any (), 0); }));
}
...
TEST (peer_container, list_fanout)
{
	...
	auto add_peer = [&node] (const uint16_t port_a) {
		ASSERT_NE (nullptr, node.network.udp_channels.insert (vban::endpoint (boost::asio::ip::address_v6::loopback (), port_a), node.network_params.protocol.protocol_version));
	};
	add_peer (9998);
...
TEST (peer_container, reachout)
{
	...
	vban::endpoint endpoint1 (boost::asio::ip::address_v6::loopback (), vban::get_available_port ());
...
TEST (peer_container, depeer)
{
	...
	vban::message_buffer buffer = { bytes->data (), bytes->size (), endpoint0 };
	system.nodes[0]->network.udp_channels.receive_action (&buffer);
	ASSERT_EQ (1, system.nodes[0]->stats.count (vban::stat::type::udp, vban::stat::detail::outdated_version));
}
