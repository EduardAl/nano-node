...
bool vban::rpc_secure::on_verify_certificate (bool preverified, boost::asio::ssl::verify_context & ctx)
{
...
void vban::rpc_secure::load_certs (boost::asio::ssl::context & context_a)
{
	try
	{
...
vban::rpc_secure::rpc_secure (boost::asio::io_context & context_a, vban::rpc_config const & config_a, vban::rpc_handler_interface & rpc_handler_interface_a) :
...
void vban::rpc_secure::accept ()
{
	auto connection (std::make_shared<vban::rpc_connection_secure> (config, io_ctx, logger, rpc_handler_interface, this->ssl_context));
